...
public class UbisoftDataService
{
    ...
    public async Task<string> GetUbisoftPlusSubscriptionDetailsAsync()
    {
        ...
        // Using the redirector which usually lands on the correct regional store page
        ...
        try
        {
            ...
            Console.WriteLine($"[HTML Dump] Page Content Start: {pageContent.Substring(0, Math.Min(pageContent.Length, 2000))}");
